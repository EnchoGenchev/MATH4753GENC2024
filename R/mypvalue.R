#' Calculate and Plot P-value for T-Distribution
#'
#' Computes the p-value for a two-tailed t-test and plots the t-distribution
#' with shaded rejection regions.
#'
#' @param t0 Observed t-statistic.
#' @param xmax Maximum x-axis value for the plot (default is 4).
#' @param n Sample size (default is 20).
#' @param alpha Significance level (default is 0.05).
#' @return A list with:
#' \item{q}{Critical t value.}
#' \item{pvalue}{Computed p-value.}
#' @examples
#' mypvalue(t0 = 2.1)
#' @importFrom stats pt dt qt
#' @export
